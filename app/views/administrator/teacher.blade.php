...
@section ('content')
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<a href="{{ route('administrator_teacher_asignar', array('id' => $user->id)) }}" class="btn btn-default">
									<span class="glyphicon glyphicon-th-list text-primary" aria-hidden="true"></span>
								</a>
								{{-- route('administrator_subject_edit', array('id' => $subject->id)) --}}
							</td>
						</tr>
						@endforeach
					</tbody>
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">Crear una nuevo profesor</h3>
					</div>
